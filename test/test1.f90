...
contains
   ...
   pure subroutine pure_subroutine(x, n, y)
      ...
      call pwrite(message='x = ', R0r64=x, format='(a,f7.3)', file_name='test/test1.txt', access='append')
      ...
      call pwrite(message='n = ', R0i32=n, format='(a,i3)', file_name='test/test1.txt', access='append')
      ...
      call pwrite(R0ch='start loop', format='(a)', file_name='test/test1.txt', access='append')
      ...
      do concurrent (i=2:n)
         ...
         ! Write Rank 0 real64 with a message and format to a file. message and format are optional
         call pwrite(message='y(i) = ', R0r64=y(i), format='(a,f7.3)', file_name='test/test1.txt', access='append')
      end do
      ...
      ! Write Rank 0 real64 with a message and format to a file. message and format are optional
      call pwrite(R0ch='end loop', format='(a)', file_name='test/test1.txt', access='append')

      ! Print Rank 0 real64 with a message and format. message and format are optional
      call pwrite(message='y = ',R1r64=y)

      ! Write Rank 0 real64 with a message and format to a file. message and format are optional
      call pwrite(message='y = ',R1r64=y, file_name='test/test1.txt', access='append')
